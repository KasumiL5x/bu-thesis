...
% \crest{\includegraphics[width=0.3\textwidth]{logos/bu-vertical-notext}}
\crest{\includegraphics[width=0.5\textwidth]{crest-low}}
% Shield logo. Minimum 30mm. This is not required, but can make the titlepage look nicer.
% \collegeshield{\includegraphics[width=0.2\textwidth]{logos/bu-vertical}}
